  ...
  export default {
    ...
    methods: {
      ...
      login() {
        ...
        this.$http.post("/api/auth/login/userLogin", user)
          .then((res) => {
      ...
      regist() {
        ...
        this.$http.post("/api/system/sysUser/register", user)
          .then((res) => {
      ...
      submitUserInfo() {
        ...
        this.$confirm('确认保存？', '提示', {
          ...
          this.$http.post("/api/system/sysUser/update", user)
            .then((res) => {
              this.$message({
                message: "修改成功,重新登陆生效!",
                type: "success"
      ...
      updateSecretInfo() {
        ...
        if (this.dialogTitle === "找回密码") {  //找回密码
          this.$http.post("/api/system/sysUser/updateForgetPassword", params)
            .then((res) => {
              this.clearDialog();
              this.$message({
                message: "修改成功，请重新登陆！",
          ...
          this.$http.post("/api/system/sysUser/updateBindByPassword", params)
            .then((res) => {
              this.$message({
      ...
      getCode() {
        if (this.codeString === "验证码") {
          ...
          this.$http.get("/api/system/sysUser/getCodeForType", params)
            .then((res) => {
              this.$message({
